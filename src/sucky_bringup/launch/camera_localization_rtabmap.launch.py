...
configurable_parameters = [{'name': 'camera_name',                  'default': 'd455', 'description': 'camera unique name'},
                        ...
                        #    {'name': 'rgb_camera.color_format',      'default': 'YUYV', 'description': 'color stream format'},
                        ...
                        #    {'name': 'depth_module.depth_profile',   'default': '640,480,15', 'description': 'depth stream profile'},
                           {'name': 'depth_module.depth_profile',   'default': '640,360,15', 'description': 'depth stream profile'},
                           ...
                           {'name': 'depth_module.exposure.1',      'default': '7000', 'description': 'Depth module first exposure value. Used for hdr_merge filter'},
                           ...
                           {'name': 'diagnostics_period',           'default': '0.5', 'description': 'Rate of publishing diagnostics. 0=Disabled'},
